...
AST_T* parser_parse_statements(parser_T* parser) 
{
    ...
    while (parser->current_token->types == TOKEN_SEMI)
    {
...
AST_T* parser_parse_variable_definition(parser_T* parser) {
    ...
    parser_eat(parser, TOKEN_EQUALS);   // expecting equal
    AST_T* variable_definition_value = parser_parse_expr(parser);   // parsing expr value
